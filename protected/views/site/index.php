			...
			<div class="col-md-4">
				<form class="form" role="form">
					<div>
						...
						<input type="text" class="form-control" id="idSearch" placeholder="Madrid, Barcelona...">
					</div>
				</form>
				
			</div>
			<div class="col-md-2">1.234.567.890 anuncios</div>
			<div class="col-md-2 blue publica text-center"><a href="#">Pon tu anuncio gratis</a></div>
			...
			<div class="col-md-8" >
				...
				<div class="row">
					...
					<div class="col-md-2" >
						<a data-slide="next" href="#myCarousel" class="carousel-control">
							<img src="<?php echo Yii::app()->request->baseUrl; ?>/img/right-arrow.png">
						</a>
					</div>
				</div>	
				...
				<div class="row">
					<div class="col-md-4" >
						...
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent sed aliquet leo. Morbi volutpat at massa id lobortis. Integer sed tortor vel mi vestibulum molestie non eget nisi. Quisque non ipsum at urna rhoncus commodo eu nec purus. Vivamus enim dui, varius et luctus quis, sollicitudin ut ligula.
						</p>
					</div>
					<div class="col-md-4" >
